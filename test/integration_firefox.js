...
*/
  ...
  it('coretcpsocket: can post an arraybuffer', function(done) {
    runTest(done, 'coretcpsocket', 'testArrayBufferPost');
  });

  it('corexhr: explicit domain fronting', function(done) {
    runTest(done, 'corexhr', 'testDomainFronting');
  });
  ...
  it('corexhr: front domain', function(done) {
    runTest(done, 'corexhr', 'testFrontDomain');
  });
